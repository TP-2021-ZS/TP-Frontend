...
function AddNewProjectContent() {
    ...
    /*
        const [websitesList, setWebsitesList] = useState([
        'https://dennikn.sk/slovensko/',
        'https://ekonomika.sme.sk/?ref=menu',
        'https://ekonomika.pravda.sk/',
        'https://www.vub.sk/investovanie/investovanie.html',
        'https://www.trend.sk/t/investovanie',
        ]);
    * */
    ...
    const [dictionaryWords, setDictionaryWords] = React.useState(dictionaryList.slice(0,10));
    ...
    */
    ...
    const validateForm = () => {
        return (!addedWebsites.length || !dictionaryWords.length || !addedEmails.length || !forbiddenList.length || !projectName.length || !reportType.length);
    }
